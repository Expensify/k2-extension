...
module.exports = React.createClass({
  ...
  getAllIssues(getOnlyMine) {
    this.setState({
      ...
      API.getIssuesForMilestone(getOnlyMine, this.props.data.title, (error, issues) => {
        this.setState({
          loading: false,
          issues,
          error
        ...
        <div className="table-list-header">
          <div className="table-list-filters">
            ...
            <div className="table-list-header-toggle float-right">
              <button className="btn-link selected" onClick={() => this.getAllIssues(false)}>
                All Issues
              </button>
              <button className="btn-link" onClick={() => this.getAllIssues(true)}>
                My Issues
              </button>
