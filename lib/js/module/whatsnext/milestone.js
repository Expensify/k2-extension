    ...
    return (
      <div className="milestone">
        <div className="table-list-header">
          <div className="table-list-filters">
            ...
            <div className="table-list-header-toggle float-right">
              ...
              <button className="btn-link" onClick={() => this.props.onMoveUp(this.props.data.id)}>
                Up
              </button>
              <button className="btn-link" onClick={() => this.props.onMoveDown(this.props.data.id)}>
                Down
              </button>
            </div>
          </div>
        ...
        <div className="border-right border-bottom border-left">
          ...
          {!this.props.loading && <Issues data={this.props.data.issues} />}
        </div>
      </div>
    );
  }
