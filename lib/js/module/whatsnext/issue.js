    ...
    return (
      <li className="Box-row">
        ...
        {!this.isOnHold && <div className="form-inline">
          ...
          {' '}
          <button className="btn tooltipped tooltipped-sw" aria-label="Increase issue priority" >▲</button>
          {' '}
          <button className="btn tooltipped tooltipped-sw" aria-label="Decrease issue priority" >▼</button>
        </div>}
