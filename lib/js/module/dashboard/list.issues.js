    ...
    return (
      <div className="issueList">
        ...
        <div className="legend">
          ...
          <div><span className="label hourly">H</span> Hourly</div>
          <div><span className="label daily">D</span> Daily</div>
          <div><span className="label weekly">W</span> Weekly</div>
          <div><span className="label monthly">M</span> Monthly</div>
          <div><span className="label newhire">FP</span> First Pick</div>
          <div><span className="label whatsnext">WN</span> WhatsNext</div>
        </div>
