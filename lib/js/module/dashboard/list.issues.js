...
const StoreDailyBugs = require('../../store/dailybugs');
...
const ActionsDailyBugs = require('../../action/dailybugs');
...
module.exports = React.createClass({
  ...
  newIssue() {
    window.location.href = 'https://github.com/Expensify/Expensify/issues/new/';
  },
    ...
    return (
      <div className="issueList">
        ...
        <div className="legend">
          ...
          <br />
          <br />
          <button onClick={this.newIssue} className="btn btn-primary" aria-label="New Issue">New Issue</button>
        ...
        <br />
        <div>
          <PanelList title="Daily Bugs (All Areas)" action={ActionsDailyBugs} store={StoreDailyBugs} item="issue" pollInterval={this.props.pollInterval} />
        </div>
        <br />
        <div>
