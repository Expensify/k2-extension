      ...
      <div className="">
        <form className="form-inline" onSubmit={this.submit}>
          ...
          <div className="checkbox">
            <label>
              <input type="checkbox" name="improvement" ref={el => this.fieldImprovement = el} /> Improvement
            </label>
          </div>
          ...
          <div className="checkbox">
            <label>
              <input type="checkbox" name="feature" ref={el => this.fieldFeature = el} /> New Feature
            </label>
          </div>
