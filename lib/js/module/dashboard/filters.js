  ...
  updateFilterFields() {
    prefs.get('issueFilters', issueFilters => {
      if (issueFilters && !_.isEmpty(issueFilters)) {
        this.fieldBug.checked = issueFilters.bug;
      ...
      <div className="">
        <form className="form-inline" onSubmit={this.submit}>
          ...
          <div className="checkbox">
            <label>
              <input type="checkbox" name="bug" ref={el => this.fieldBug = el} /> Bug
            </label>
          </div>

          <div className="checkbox">
            <label>
              <input type="checkbox" name="task" ref={el => this.fieldTask = el} /> Task
            </label>
          </div>

          <div className="checkbox">
            <label>
              <input type="checkbox" name="feature" ref={el => this.fieldFeature = el} /> Feature
            </label>
          </div>
