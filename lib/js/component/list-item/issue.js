...
module.exports = React.createClass({
  parseIssue() {
    ...
    this.isFeature = _(this.props.data.labels).findWhere({name: 'NewFeature'}) ? <sup>F</sup> : null;
    ...
    this.isWhatsNext = _(this.props.data.labels).findWhere({name: 'WhatsNext'}) ? <span className="label whatsnext">WN</span> : null;
    ...
    this.isHelpWanted = _(this.props.data.labels).findWhere({name: 'Help Wanted'}) ? ' help-wanted' : '';
