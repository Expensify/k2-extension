...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    let mergeableStateDescription = '';

    switch (mergeableState) {
    case 'dirty':
      mergeableStateDescription = 'Merge Conflicts';
      break;
    case 'blocked':
      if (this.props.data.reviews) {
        mergeableStateDescription = 'Changes Requested';
      } else {
        mergeableStateDescription = 'Needs Review';
      }
      break;
    case 'behind':
      mergeableStateDescription = 'Branch Behind';
      break;
    case 'unstable':
      mergeableStateDescription = 'Merge With Caution';
      break;
    case 'has_hooks':
    case 'clean':
      mergeableStateDescription = 'Approved';
      break;
    case 'draft':
      mergeableStateDescription = 'Draft';
      break;
    case 'unknown':
    default:
