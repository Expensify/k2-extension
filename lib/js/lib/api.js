...
function getMilestonesGraphQL(view, cb) {
  let result = [];
  const currentUser = $('.Header-link .avatar').attr('alt').replace('@', '');
...
function getHourlyIssues(cb) {
  getIssuesByLabel('hourly', getCurrentUser(), cb);
}
...
function getDailyIssues(cb) {
  getIssuesByLabel('daily', getCurrentUser(), cb);
}
...
function getWeeklyIssues(cb) {
  getIssuesByLabel('weekly', getCurrentUser(), cb);
}
...
function getMonthlyIssues(cb) {
  getIssuesByLabel('monthly', getCurrentUser(), cb);
}
...
function getNoneIssues(cb) {
  getIssuesByLabel('none', getCurrentUser(), cb);
}
